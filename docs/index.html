...
<body>
  ...
  <img src="img/final.jpg" alt="Smiley face" height="700" width="600" align="center" style="position: absolute; top: 30px; left: 30px;"> </img>
    ...
    <div align="right"> -Amandeep Takhar</div>
    <div align="right"> UIUC - Summer 2018</div>
<br></br>    
<b>About</b> - This presentation shows the trend of Age adjusted death rates from the year 2003 to 2013 distributed across states.
...
<br></br>
<b>Type of visualization</b> - The visualization shows  an interactive slideshow structure. Through 3 slides  we tell a sequential story and enable user to interact with in the slides.
Each slide contains 'next' and 'previous' arrow allowing users to guide forwards and backwards.
<br></br>
<b>Annotations</b> - Each slide contains text annotation depicting the data.In the state chart it shows annotations on the legends, with tooltip showing the state name.
In bar and pie chart it shows the number of deaths as the annotation, with pie chart segregating the causes on realtime.
<br></br>
<b>Parameters and Triggers</b> - Mouse over and mouse out in the MAP acts as the triggers to activate the tooltip.
 I have also made bar chart and pie chart dependent on each other, the category chosen in pie act as a parameter filter to the bar chart and vice versa.
 Clickable zoom feature is also used in the state graph to zoom in the map for detailed visualization.
 Right and left arrows are used to navigate through the slides.
<br></br>
    </font>
    </div>
